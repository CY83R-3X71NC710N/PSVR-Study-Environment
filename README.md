...
Simply find a VR study environment you want to use on youtube, download using youtubedl then get a recording of the resources you wish to study in mp4 format. Provide both of these to the python script.
